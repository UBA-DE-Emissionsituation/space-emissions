...
class TestEra5Download:
    def test_invalid_init_era5_input(self):
        ...
        with pytest.raises(ValueError):  # wrong path
            era5_download(period=DateRange(end="2016-01-02", start="2016-01-03"), data_dir='\/this path will not work')
...
class TestTropomiDownload:
    def test_invalid_init_s5p_input(self):
        ...
        with pytest.raises(ValueError):  # wrong path
            tropomi_download(period=DateRange(end="2016-01-02", start="2016-01-03"),
                             data_dir='\/this path will not work')
